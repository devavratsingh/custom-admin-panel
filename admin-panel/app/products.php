        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            while($rescat = mysqli_fetch_assoc($catquery)) { 
              $catid = $rescat['product_category'];
              $catquery1 = mysqli_query($conn, "SELECT * FROM categories WHERE id='$catid'");
              $resultcat = mysqli_fetch_assoc($catquery1);
              ?>
            <tr>
              ...
              <td>
                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#Delete">Delete</a>
